<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
    <%@ page import="com.tita.*,com.bean.*,java.util.*,java.io.PrintWriter" %>
<%
...
<%
	...
	if(request.getParameter("number")!=null){
		 pages=Integer.parseInt(request.getParameter("number").toString());
	}else pages=1;
...
<section id="inner-page">
  	<div class="container">
	    ...
	    <div class="test-wrap">
		    ...
		    <div class="row">
		      	<div class="col-sm-12 test-border">
		        	<div class="col-sm-6">
		        		<a href="test_detail/test_show.jsp" class="img-a"><img src="images/test/tet.jpg" class="img-responsive center-block" alt="test"></a>	
		        	</div> 
		        	<div class="col-sm-6">
									<%
										
										String TestHref="test_detail/test_show.jsp?textid="+TB.getTest_id()+"&textpop="+TB.getTest_pop_sum();
										String string="text"+TB.getTest_id();
										session.setAttribute(string, TB);    //封装text对象
									%>
		        		<p class="test-p1"><a href=<%=TestHref %>><%=TB.getTest_title() %></a><br/>
							<%=TB.getTest_abstract() %>
							<br/>
							<br/>
							<span class="test-people">
								<span class="people-icon"></span><%=TB.getTest_pop_sum() %>人测试过
							</span>
		        		</p>        	 		
		        	</div>
		        </div>
	    ...
	    <div class="paging">
	    	<div class="row">
	    		<div class="col-sm-12 center">
	    			<ul>
	    				<li><a href="test.jsp?number=1">Prev</a></li>
	    				<%
	    					for(int i=1;i<=count;i++){
	    						String addr="test.jsp?number="+i;
	    				%>
	    				<li><a href=<%=addr %>><%=i %></a></li>
	    				<%
	    					}
	    					String LastAddr="test.jsp?number="+count;
	    				%>
	    				<li><a href=<%=LastAddr %>>Next</a></li>
	    			</ul>
	    		</div>
	    	</div>
	    </div>
